...
- Адаптивность дизайна под разные разарешения устройств. Подходит для эрканов > 600px, для меньших размеров - отдельная мобильная версия
- Корректная обработка ошибок во время фетча (сетевых) и ошибок, пришедших с сервера (HTTP):
    ...
    - + фикс некоторых багов (накладка элементов друг на друга, форматирование текста в истории модерации, форматирование таблиц в карточках объявлений, исправлена схема фидбека для "Отклонено" и "На доработку")
...
- Проверки ответов и обработчики ошибок, пришедших с сервера, так как это критично для больших компаний и объемов данных
- Bulk операции
